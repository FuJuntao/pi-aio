...
**Standards axis** - inputs: the diff command, the commit list, the standards-source files found in step 3, **plus the smell baseline from step 3 pasted in full** (a sub-agent has no other access to it).
